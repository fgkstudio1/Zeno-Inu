...
const metrics = [
  { id: 1, stat: '8K+', emphasis: 'People HOLDING', rest: 'our greatest fucking ever token' },
  { id: 2, stat: '25K+', emphasis: 'Inquiries made', rest: 'about the hell is this token about' },
  { id: 3, stat: '98%', emphasis: 'Customer satisfaction', rest: ', at least for the first two days the coin mooned' },
  { id: 4, stat: '12M+', emphasis: 'Issues resolved', rest: 'when we finally paid everyone back' },
]
  ...
  return (
        ...
        <div className="bg-gray-900 pt-6">
          ...
          >
            ...
            <div className="hidden md:flex md:items-center md:space-x-6">
              <a
                href="#"
                className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-700 hover:bg-gray-700"
              >
                Get from uniswap
              </a>
            </div>
              ...
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div className="lg:py-24">
                  ...
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    <span className="block">We HODL</span>
                    <span className="block text-indigo-400">We Family</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                     We at Massive (MSV) coin are here to stay. We hold till we drop. For realz.
                  </p>
                  <div className="mt-10 sm:mt-12">
                    <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                      ...
                      <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                        You need a crypto wallet extension like metamask
                      </p>
                    </form>
                  </div>
                </div>
    ...
    <div className="bg-gray-900">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <p className="text-center text-base font-semibold uppercase text-gray-200 tracking-wider">
          Find our token on
        </p>
        <div className="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
          <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-700">
            <img
              className="max-h-12"
